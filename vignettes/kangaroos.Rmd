...
Let's see a plot of the fitted animal distribution with respect to transects (Fig. \ref{gradfiginside}).

```{r gradfig, fig.cap="Fitted animal density gradient \\label{gradfiginside}", fig.height=3}
...
Given the (slightly) smaller AIC for the half normal detection function, Fig. \ref{HN} shows the fit of the half normal detection function to the observed detection distances.

```{r, fig.cap="Fitted half normal detection function accounting for non-uniform distribution. \\label{HN}", fig.height=3}
